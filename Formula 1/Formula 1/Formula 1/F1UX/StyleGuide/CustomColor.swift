...
extension CustomColor {
	var uiColor: UIColor {
		...
		switch self {
		case .textError:
			color = #colorLiteral(red: 0.9529411765, green: 0.1529411765, blue: 0.2078431373, alpha: 1)
		case .textHighlighted:
		...
		case .buttonIconTintColorPrimary:
			color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
		case .buttonTextPrimaryTextColor:
			color = #colorLiteral(red: 0.9411764706, green: 0.1960784314, blue: 0.1450980392, alpha: 1)
		case .iconPrimaryTint:
			color = #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1)
		case .iconSecondaryTint:
			color = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
