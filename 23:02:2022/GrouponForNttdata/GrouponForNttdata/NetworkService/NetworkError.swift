...
extension NetworkError {
    ...
    public static var unableToParseResponse: NetworkError {
        return NetworkError(status: .unableToParseResponse)
    }
    
    public static var unableToParseRequest: NetworkError {
        return NetworkError(status: .unableToParseRequest)
    }
    
    public static var unknownError: NetworkError {
        return NetworkError(status: .unknown)
    }
